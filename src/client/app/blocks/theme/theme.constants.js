...
(function () {
    ...
    var IMAGES_ROOT = 'images/dashboard/';
    ...
    angular.module('blocks.theme')
        ...
        .constant('layoutPaths', {
            images: {
                ...
                amMap: 'images/dashboard/theme/vendor/ammap//dist/ammap/images/',
                amChart: 'images/dashboard/theme/vendor/amcharts/dist/amcharts/images/'
            }
        })
